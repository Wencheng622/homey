  ...
  const handleSendResetEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mockSuccess) {
        ...
        showMessage('Failed to send reset email. Please try again.', true);
      }
    } catch (error) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-amber-100 to-amber-300 relative">
        ...
        <div className="relative z-10 w-full max-w-md bg-white rounded-[36px] shadow-2xl overflow-hidden text-center p-8 animate-in fade-in zoom-in duration-300">
          <div className="h-2 bg-gradient-to-r from-blue-500 via-blue-400 to-blue-500" />
          
          <div className="py-8">
            <div className="w-24 h-24 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <i className="fas fa-envelope-open-text text-5xl text-blue-600" />
            </div>
        ...
        <div className="p-8 pb-10 sm:p-7 sm:pb-9">
          <div className="text-center mb-7">
            <div className="bg-amber-50 w-[70px] h-[70px] rounded-[28px] flex items-center justify-center mx-auto mb-3 shadow-md">
              <i className="fas fa-key text-4xl text-amber-600" />
            </div>
            <h1 className="text-3xl font-bold tracking-tight text-stone-800">Forgot Password?</h1>
            <div className="text-sm font-medium text-amber-700">We'll help you reset it</div>
          </div>
